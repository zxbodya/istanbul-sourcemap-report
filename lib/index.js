 ...
 *                          is report options
 * @param  {Object} reportOptions? An object containing the common report options.
...
module.exports = function (sources, reports, reportOptions = {}) {
  ...
  const collector = remap(sources.map(filePath => JSON.parse(fs.readFileSync(filePath))), {
    sources: sourceStore,
  });
